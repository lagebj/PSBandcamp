...
Properties {
    ...
    $DocsRootDir = "$ModuleRootDir\docs"
    $SrcRootDir = $ModuleRootDir
    [System.Diagnostics.CodeAnalysis.SuppressMessage('PSUseDeclaredVarsMoreThanAssigments', '')]
    $TestRootDir = "$ModuleRootDir\tests"
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage('PSUseDeclaredVarsMoreThanAssigments', '')]
    $CodeCoverageFiles = "$SrcRootDir\scripts\public\*.ps1", "$SrcRootDir\scripts\private\*.ps1", "$SrcRootDir\*.psm1"
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage('PSUseDeclaredVarsMoreThanAssigments', '')]
    $SettingsPath = "$env:LOCALAPPDATA\PSBandcamp\SecuredBuildSettings.clixml"
